...
const fullText1 = splitLines("Xin chào Công Chúa <3", 3);
const fullText2 = splitLines("Chúc Công Chúa một Valentine thật ấm áp và ngọt ngào🌸, nụ cười luôn nở trên môi 💗", 3);
const fullText3 = splitLines("Tạm biệt nha, chúc Nhi một cuối tuần vui vẻ✨", 3);
